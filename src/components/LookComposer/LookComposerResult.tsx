...
export const LookComposerResult: React.FC<LookComposerResultProps> = ({
 ...
 <div
 className={(isDark ? 'bg-neutral-900 border-neutral-800' : 'bg-white border-gray-200 ') + ' rounded-2xl border overflow-hidden flex flex-col'}
 >
 ...
 >
  ...
  Download ({downloadableImages.length})
 </button>
 ...
 <h3 className={(isDark ? 'text-white' : 'text-gray-900') + ' text-base font-bold font-serif'}>Sair sem salvar?</h3>
 ...
 <h3 className={(isDark ? 'text-white' : 'text-gray-900') + ' text-base font-bold font-serif'}>Descartar look?</h3>
