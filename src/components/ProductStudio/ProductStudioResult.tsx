    ...
    <div className={'min-h-screen flex flex-col overflow-y-auto ' + (theme === 'dark' ? 'bg-black' : 'bg-gray-50')}>
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full p-4 md:p-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 md:gap-6">
          ...
          <div className="lg:col-span-3 flex flex-col">
            <div
              className={(theme === 'dark' ? 'bg-neutral-900 border-neutral-800' : 'bg-white border-gray-200 shadow-sm') + ' rounded-2xl border overflow-hidden flex flex-col'}
            >
      ...
      {showExitModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className={(theme === 'dark' ? 'bg-neutral-900 border-neutral-800' : 'bg-white border-gray-200') + ' relative z-10 w-full max-w-sm rounded-2xl border p-5 shadow-2xl'}>
            <div className="text-center mb-4">
              <div className="w-12 h-12 rounded-full bg-yellow-500/20 flex items-center justify-center mx-auto mb-3">
                <i className="fas fa-exclamation-triangle text-yellow-500 text-xl"></i>
              </div>
              <h3 className={(theme === 'dark' ? 'text-white' : 'text-gray-900') + ' text-base font-bold'}>Sair sem salvar?</h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className={(theme === 'dark' ? 'bg-neutral-900 border-neutral-800' : 'bg-white border-gray-200') + ' relative z-10 w-full max-w-sm rounded-2xl border p-5 shadow-2xl'}>
            <div className="text-center mb-4">
              ...
              <h3 className={(theme === 'dark' ? 'text-white' : 'text-gray-900') + ' text-base font-bold'}>Descartar imagens?</h3>
